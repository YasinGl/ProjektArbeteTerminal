    ...
    while True:     # Huvudloop för att köra programmet kontinuerligt.
        if not inloggad_konto:         # Om ingen användare är inloggad, visa huvudmenyn.
            ...
            if val == 1:             # Logga in-valet.
                try:
                    kontonummer = getpass(f"{TerminalColors.OKBLUE}Ange ditt kontonummer: {TerminalColors.ENDC}")
                ...
                pin = getpass(f"{TerminalColors.OKBLUE}Ange ditt lösenord: {TerminalColors.ENDC}")
